...
@interface GTTooltipView ()
@property (assign, nonatomic) CGRect lableFrame;
@end

@implementation GTTooltipView
...
+ (GTTooltipView *)createTooltipViewWithFrame:(CGRect)frame markedWords:(NSString *)markWords view:(UIView *)view{
    ...
    GTTooltipView * gtTooltipView =[[GTTooltipView alloc] initWithTooltipViewOfMessage:markWords LableFrame:frame];
